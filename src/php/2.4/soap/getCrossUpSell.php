...
/**
 * Sample SOAP client for requesting cross-sell and upsel info on Digital Content SOAP interface v2.4
 *
 * Use on the command line the following way (Linux): `php getCrossUpSell.php secret productRef1 [ productRef2 [ ... ] ]`
...
foreach ($productRefs as $productRef) {
    $products[] = ["productRef" => $productRef, "quantity" => 1];
}
$payload = array(
    "secret"  => SECRET,
    "request" => array(
